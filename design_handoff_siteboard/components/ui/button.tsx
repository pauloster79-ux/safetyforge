 ...
 * Site Board — Button
 *
 * Replaces frontend/src/components/ui/button.tsx
 *
 * Changes vs existing:
 *   • Primary variant darkens via --machine-dark on hover (your existing #D9A200)
 *   • Added subtle inset highlight on primary to read as "stamped metal"
 *   • Press state uses translateY(1px) — already in your existing file, kept
 *   • Ghost variant gains a 4% machine-yellow hover tint to feel "live"
 *   • Destructive stays tonal (10% bg, accent text) — matches existing
 */
